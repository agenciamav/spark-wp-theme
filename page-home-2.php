						...
						<div class="author widget">
							...
							<div class="author-body text-center">
								...
								<div class="author-bio">
									<!-- <h3>Spark</h3> -->
									<div class="office">
										<p><i class="fa fa-building"></i> <?php echo tr_options_field('[tr_theme_options][endereco]'); ?><br/>
											<i class="fa fa-map-marker"></i> <?php echo tr_options_field('[tr_theme_options][cidade]'); ?>. <?php echo tr_options_field('[tr_theme_options][cep]'); ?></p>
											<h4><i class="fa fa-phone"></i><?php echo tr_options_field('[tr_theme_options][telefone]'); ?></h4>
											<p><i class="fa fa-envelope"></i> <a href="mailto:<?php echo tr_options_field('[tr_theme_options][e_mai]'); ?>"><?php echo tr_options_field('[tr_theme_options][e_mail]'); ?></a></p>
										</div>
										<p>
										</p>
									</div>
