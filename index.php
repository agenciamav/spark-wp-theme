		...
		<div class="row">
			<div class="col-md-4 col-lg-4 col-xs-12">
				<div class="media">
					...
					<div class="media-body">
						<a href="<?php echo site_url('/servicos/suporte') ?>"><h4 class="media-heading">Atendimento e Suporte</h4></a>
			...
			<div class="col-md-4 col-lg-4 col-xs-12">
				<div class="media">
					...
					<div class="media-body">
						<a href="<?php echo site_url('/docs') ?>"><h4 class="media-heading">Documentação Online</h4></a>
			...
			<div class="col-md-4 col-lg-4 col-xs-12">
				<div class="media">
					...
					<div class="media-body">
						<a href="<?php echo site_url('/news') ?>"><h4 class="media-heading">Informação</h4></a>
